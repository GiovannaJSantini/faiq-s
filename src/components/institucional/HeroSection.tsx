...
export function HeroSection() {
  ...
  return <section className="hero-gradient text-primary-foreground py-20 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button onClick={handleGoogleSignIn} size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground">
              ...
              <Button variant="outline" size="lg" onClick={() => document.getElementById('indicadores')?.scrollIntoView({
              behavior: 'smooth'
            })} className="border-primary-foreground/30 hover:bg-primary-foreground/10 text-black text-base">
                Ver Indicadores
              </Button>
            </div>
            ...
            <div className="institutional-card animate-float">
              <div className="space-y-4">
                ...
                <div className="h-2 bg-muted rounded-full overflow-hidden">
                  <div className="h-full bg-gradient-success rounded-full" style={{
                  width: '85%'
                }}></div>
                </div>
      ...
      <LGPDConsentModal open={showConsentModal} onOpenChange={setShowConsentModal} onAccept={handleConsentAccept} />
    </section>;
}