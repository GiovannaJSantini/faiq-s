  ...
  return <section id="portfolio" className="py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="space-y-6">
          {services.map((service, index) => <Card key={index} className="overflow-hidden">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-0">
                ...
                <CardContent className="bg-muted/30 p-6 flex flex-col justify-center">
                  ...
                  <ul className="space-y-2">
                    {service.deliverables.map((deliverable, idx) => <li key={idx} className="flex items-start gap-2 text-sm text-muted-foreground">
