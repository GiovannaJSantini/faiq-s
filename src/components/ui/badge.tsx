  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-medium transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        accent: "border-transparent bg-accent text-accent-foreground hover:bg-accent/90 shadow-soft",
        success: "border-transparent bg-success-light text-success border-success/20",
        warning: "border-transparent bg-warning-light text-warning border-warning/20",
      },
    },
    defaultVariants: {
      variant: "default",
